...
public class Dunya extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view= inflater.inflate(R.layout.fragment_dunya, container, false);
        ...
        mRecyclerView= (RecyclerView) view.findViewById(R.id.recycle_dunya);
        ...
        new GetNews("http://www.haberturk.com/rss/kategori/dunya.xml", new NewsListener() {
            @Override
