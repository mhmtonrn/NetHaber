...
public class Ekonomi extends Fragment {
    ...
    public Ekonomi(Context mContext) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_ekonomi, container, false);
        ...
        mRecyclerView= (RecyclerView) view.findViewById(R.id.recycle_ekonomi);
        ...
        new GetNews("http://www.haberturk.com/rss/ekonomi.xml", new NewsListener() {
            @Override
