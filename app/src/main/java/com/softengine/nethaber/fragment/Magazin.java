...
public class Magazin extends Fragment {
    ...
    public Magazin(Context mContext) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_magazin, container, false);
        ...
        mRecyclerView= (RecyclerView) view.findViewById(R.id.recycle_magazin);
        ...
        new GetNews("http://www.haberturk.com/rss/magazin.xml", new NewsListener() {
            @Override
